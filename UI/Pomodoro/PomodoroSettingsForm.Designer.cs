...
partial class PomodoroSettingsForm
{
    ...
    private void InitializeComponent()
    {
        ...
        // 
        // tlpContent (5 Rows, 5 Cols for time inputs)
        // Col 0: Label (AutoSize)
        // Col 1: Input Min (Percent 25%)
        // Col 2: Unit Min (AutoSize)
        // Col 3: Input Sec (Percent 25%)
        // Col 4: Unit Sec (AutoSize)
        // 
        ...
        // Row 1: Work
        AddRow(0, lblWorkTime, nudWorkTimeMin, lblWorkMinUnit, nudWorkTimeSec, lblWorkSecUnit);
        // Row 2: Short Break
        AddRow(1, lblShortBreakTime, nudShortBreakTimeMin, lblShortBreakMinUnit, nudShortBreakTimeSec, lblShortBreakSecUnit);
        // Row 3: Long Break
        AddRow(2, lblLongBreakTime, nudLongBreakTimeMin, lblLongBreakMinUnit, nudLongBreakTimeSec, lblLongBreakSecUnit);

        // Row 4: Warning 1 (Only needs 3 cols, span the rest?)
        // 为了布局整齐，我们将 Warning 输入框放在 Col 1, 单位放在 Col 2
        this.tlpContent.Controls.Add(this.lblWarningLongTime, 0, 3);
        this.tlpContent.Controls.Add(this.nudWarningLongTime, 1, 3);
        this.tlpContent.Controls.Add(this.lblWarningLongTimeUnit, 2, 3);

        // Row 5: Warning 2
        this.tlpContent.Controls.Add(this.lblWarningShortTime, 0, 4);
        this.tlpContent.Controls.Add(this.nudWarningShortTime, 1, 4);
        this.tlpContent.Controls.Add(this.lblWarningShortTimeUnit, 2, 4);
        ...
        this.MinimumSize = new System.Drawing.Size(450, 0); // 宽度稍微宽点
